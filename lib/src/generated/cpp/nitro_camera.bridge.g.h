...
NITRO_EXPORT void* nitro_camera_get_available_camera_devices(void);
...
NITRO_EXPORT void nitro_camera_set_sampling_rate(int64_t textureId, int64_t samplingRate);
NITRO_EXPORT void nitro_camera_set_filter_shader(int64_t textureId, const char* shaderSource);
NITRO_EXPORT void nitro_camera_update_overlay(int64_t textureId, uint8_t* overlayData, int64_t overlayData_length);
NITRO_EXPORT void nitro_camera_reset(void);
