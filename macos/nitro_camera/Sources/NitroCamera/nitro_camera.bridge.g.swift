...
public func _nitro_camera_call_requestCameraPermission(_ errPtr: Int64, _ dartPort: Int64) {
    ...
    Task.detached {
        do {
        let _result = try await impl.requestCameraPermission()
...
public func _nitro_camera_call_requestMicrophonePermission(_ errPtr: Int64, _ dartPort: Int64) {
    let _errPtr = UnsafeMutablePointer<NitroError>(bitPattern: UInt(bitPattern: Int(errPtr)))
    guard let impl = NitroCameraRegistry.impl else {
        var _null = Dart_CObject()
        _null.type = Dart_CObject_kNull
    ...
    Task.detached {
        do {
        let _result = try await impl.requestMicrophonePermission()
        var _obj = Dart_CObject()
        _obj.type = Dart_CObject_kInt64
        _obj.value.as_int64 = Int64(_result)
        Dart_PostCObject_DL(dartPort, &_obj)
...
public func _nitro_camera_call_getAvailableCameraDevicesJson(_ errPtr: Int64, _ dartPort: Int64) {
    let _errPtr = UnsafeMutablePointer<NitroError>(bitPattern: UInt(bitPattern: Int(errPtr)))
    guard let impl = NitroCameraRegistry.impl else {
        var _null = Dart_CObject()
        _null.type = Dart_CObject_kNull
...
public func _nitro_camera_call_openCamera(_ deviceId: UnsafePointer<CChar>?, _ width: Int64, _ height: Int64, _ fps: Int64, _ enableAudio: Int64, _ errPtr: Int64, _ dartPort: Int64) {
    let _errPtr = UnsafeMutablePointer<NitroError>(bitPattern: UInt(bitPattern: Int(errPtr)))
    ...
    Task.detached {
        do {
        let _result = try await impl.openCamera(deviceId: deviceIdStr, width: width, height: height, fps: fps, enableAudio: enableAudio)
        var _obj = Dart_CObject()
        _obj.type = Dart_CObject_kInt64
        _obj.value.as_int64 = Int64(_result)
        Dart_PostCObject_DL(dartPort, &_obj)
...
public func _nitro_camera_call_closeCamera(_ textureId: Int64, _ errPtr: Int64, _ dartPort: Int64) {
    let _errPtr = UnsafeMutablePointer<NitroError>(bitPattern: UInt(bitPattern: Int(errPtr)))
    guard let impl = NitroCameraRegistry.impl else {
        var _null = Dart_CObject()
        _null.type = Dart_CObject_kNull
...
public func _nitro_camera_call_takePhoto(_ textureId: Int64, _ errPtr: Int64, _ dartPort: Int64) {
    let _errPtr = UnsafeMutablePointer<NitroError>(bitPattern: UInt(bitPattern: Int(errPtr)))
    guard let impl = NitroCameraRegistry.impl else {
        var _null = Dart_CObject()
        _null.type = Dart_CObject_kNull
    ...
    Task.detached {
        do {
        let _result: PhotoResult? = try await impl.takePhoto(textureId: textureId)
...
public func _nitro_camera_call_startVideoRecording(_ textureId: Int64, _ outputPath: UnsafePointer<CChar>?, _ options: UnsafeRawPointer?, _ errPtr: Int64, _ dartPort: Int64) {
    let _errPtr = UnsafeMutablePointer<NitroError>(bitPattern: UInt(bitPattern: Int(errPtr)))
    ...
    let options_dec = options!.assumingMemoryBound(to: _RecordingOptionsC.self).pointee.toSwift()
    Task.detached {
        do {
        try await impl.startVideoRecording(textureId: textureId, outputPath: outputPathStr, options: options_dec)
        var _null = Dart_CObject()
        _null.type = Dart_CObject_kNull
        Dart_PostCObject_DL(dartPort, &_null)
        } catch {
...
public func _nitro_camera_call_stopVideoRecording(_ textureId: Int64, _ errPtr: Int64, _ dartPort: Int64) {
    let _errPtr = UnsafeMutablePointer<NitroError>(bitPattern: UInt(bitPattern: Int(errPtr)))
    guard let impl = NitroCameraRegistry.impl else {
        var _null = Dart_CObject()
        _null.type = Dart_CObject_kNull
    ...
    Task.detached {
        do {
        let _result: RecordingResult? = try await impl.stopVideoRecording(textureId: textureId)
        let _recPtr = (_result ?? nil)?.toNative()
        var _obj = Dart_CObject()
        _obj.type = Dart_CObject_kInt64
        _obj.value.as_int64 = _recPtr != nil ? Int64(bitPattern: UInt64(UInt(bitPattern: _recPtr!))) : 0
...
public func _nitro_camera_call_configure(_ textureId: Int64, _ config: UnsafeRawPointer?, _ errPtr: Int64, _ dartPort: Int64) {
    let _errPtr = UnsafeMutablePointer<NitroError>(bitPattern: UInt(bitPattern: Int(errPtr)))
    guard let impl = NitroCameraRegistry.impl else {
        var _null = Dart_CObject()
        _null.type = Dart_CObject_kNull
    ...
    let config_dec = config!.assumingMemoryBound(to: _CameraConfigC.self).pointee.toSwift()
    Task.detached {
        do {
        let _result: ResolvedConfig? = try await impl.configure(textureId: textureId, config: config_dec)
...
public func _nitro_camera_call_takePhotoWithOptions(_ textureId: Int64, _ options: UnsafeRawPointer?, _ errPtr: Int64, _ dartPort: Int64) {
    let _errPtr = UnsafeMutablePointer<NitroError>(bitPattern: UInt(bitPattern: Int(errPtr)))
    guard let impl = NitroCameraRegistry.impl else {
        var _null = Dart_CObject()
        _null.type = Dart_CObject_kNull
    ...
    let options_dec = options!.assumingMemoryBound(to: _PhotoOptionsC.self).pointee.toSwift()
    Task.detached {
        do {
        let _result: PhotoResult? = try await impl.takePhotoWithOptions(textureId: textureId, options: options_dec)
        let _recPtr = (_result ?? nil)?.toNative()
        var _obj = Dart_CObject()
        _obj.type = Dart_CObject_kInt64
        _obj.value.as_int64 = _recPtr != nil ? Int64(bitPattern: UInt64(UInt(bitPattern: _recPtr!))) : 0
...
public func _nitro_camera_call_takeSnapshot(_ textureId: Int64, _ errPtr: Int64, _ dartPort: Int64) {
    let _errPtr = UnsafeMutablePointer<NitroError>(bitPattern: UInt(bitPattern: Int(errPtr)))
    guard let impl = NitroCameraRegistry.impl else {
        var _null = Dart_CObject()
        _null.type = Dart_CObject_kNull
    ...
    Task.detached {
        do {
        let _result: PhotoResult? = try await impl.takeSnapshot(textureId: textureId)
        let _recPtr = (_result ?? nil)?.toNative()
        var _obj = Dart_CObject()
        _obj.type = Dart_CObject_kInt64
        _obj.value.as_int64 = _recPtr != nil ? Int64(bitPattern: UInt64(UInt(bitPattern: _recPtr!))) : 0
