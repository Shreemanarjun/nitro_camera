...
import 'combo_analysis.dart';
import 'combo_recording.dart';
import 'combo_stress.dart';
...
export 'combo_analysis.dart';
export 'combo_recording.dart';
export 'combo_stress.dart';
...
final class Modules {
  ...
  late final comboAnalysis = ComboAnalysis(_$);
  late final comboRecording = ComboRecording(_$);
  late final comboStress = ComboStress(_$);
