...
import 'events/event_map_test.dart' as events__event_map_test;
import 'events/frame_drop_reasons_test.dart' as events__frame_drop_reasons_test;
import 'events/thermal_controller_stream_test.dart' as events__thermal_controller_stream_test;
...
import 'preview/capture_burst_stream_test.dart' as preview__capture_burst_stream_test;
import 'preview/config_storm_test.dart' as preview__config_storm_test;
import 'preview/hdr_image_test.dart' as preview__hdr_image_test;
import 'preview/long_stream_stability_test.dart' as preview__long_stream_stability_test;
import 'preview/low_light_boost_image_test.dart' as preview__low_light_boost_image_test;
import 'preview/noop_reconfigure_test.dart' as preview__noop_reconfigure_test;
import 'preview/sustained_preview_test.dart' as preview__sustained_preview_test;
import 'preview/zoom_sweep_test.dart' as preview__zoom_sweep_test;
import 'stability/background_resume_test.dart' as stability__background_resume_test;
import 'stability/detector_churn_test.dart' as stability__detector_churn_test;
import 'stability/mode_churn_test.dart' as stability__mode_churn_test;
import 'stability/thermal_state_test.dart' as stability__thermal_state_test;
...
// START: GENERATED TEST GROUPS
  ...
  group('events.event_map_test', events__event_map_test.main);
  group('events.frame_drop_reasons_test', events__frame_drop_reasons_test.main);
  group('events.thermal_controller_stream_test', events__thermal_controller_stream_test.main);
  ...
  group('preview.capture_burst_stream_test', preview__capture_burst_stream_test.main);
  group('preview.config_storm_test', preview__config_storm_test.main);
  group('preview.hdr_image_test', preview__hdr_image_test.main);
  group('preview.long_stream_stability_test', preview__long_stream_stability_test.main);
  group('preview.low_light_boost_image_test', preview__low_light_boost_image_test.main);
  group('preview.noop_reconfigure_test', preview__noop_reconfigure_test.main);
  group('preview.sustained_preview_test', preview__sustained_preview_test.main);
  group('preview.zoom_sweep_test', preview__zoom_sweep_test.main);
  group('stability.background_resume_test', stability__background_resume_test.main);
  group('stability.detector_churn_test', stability__detector_churn_test.main);
  group('stability.mode_churn_test', stability__mode_churn_test.main);
  group('stability.thermal_state_test', stability__thermal_state_test.main);
