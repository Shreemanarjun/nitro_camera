...
class ControlPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Watch((context) {
      ...
      final isProcessing = CameraState.isProcessingFrames.value;
      final devices = CameraState.devices.value;
      final selectedDevice = CameraState.currentDevice.value;
      final selectedWidth = CameraState.width.value;
      final selectedFps = CameraState.fps.value;
      final pixelFormat = CameraState.pixelFormat.value;
      final samplingRate = CameraState.samplingRate.value;
                          ...
                          children: devices.map((d) {
                            ...
                            return Padding(
                              ...
                              child: _PremiumChip(
                                ...
                                onPressed: isChanging ? null : () => CameraState.selectDevice(d),
                              ),
                            );
                          }).toList(),
                        ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Wrap(spacing: 8, runSpacing: 8, children: [
                                  _ChoiceBtn(label: '720', isSelected: selectedWidth == 1280, onTap: () => CameraState.setResolution(1280, 720)),
                                  _ChoiceBtn(label: '1080', isSelected: selectedWidth == 1920, onTap: () => CameraState.setResolution(1920, 1080)),
                                ]),
                              ],
                            ),
                          ),
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 12),
                                Wrap(spacing: 8, runSpacing: 8, children: [
                                  _ChoiceBtn(label: '30', isSelected: selectedFps == 30, onTap: () => CameraState.setFps(30)),
                                  _ChoiceBtn(label: '60', isSelected: selectedFps == 60, onTap: () => CameraState.setFps(60)),
                                ]),
                              ],
                            ),
                          ),
                      ...
                      Row(
                        ...
                        children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Wrap(spacing: 8, children: [
                                  _ChoiceBtn(label: 'YUV', isSelected: pixelFormat == 0, onTap: () => CameraState.setPixelFormat(0)),
                                  _ChoiceBtn(label: 'BGRA', isSelected: pixelFormat == 1, onTap: () => CameraState.setPixelFormat(1)),
                                ]),
                              ],
                            ),
                          ),
                          _StreamToggle(
                            ...
                            onChanged: isRunning ? CameraState.toggleProcessing : null,
                          ),
                        ],
                      ),
                      const SizedBox(height: 24),
                          ...
                          Expanded(
                            child: Watch((context) => SliderTheme(
                              ...
                              child: Slider(
                                ...
                                max: 30,
                                divisions: 29,
                                onChanged: isRunning ? (v) => CameraState.setSamplingRate(v.toInt()) : null,
                              ),
                            )),
                          ),
